...
class PageType{
	...
	public function Delete(){
		...
		$pageTypeUniqId = mysql_real_escape_string($pageTypeUniqId); // clean data
	
		$delete = mysql_query("DELETE FROM PageTypes WHERE PageTypeId=$this->PageTypeId");
		
		$delete = mysql_query("DELETE FROM Pages WHERE PageTypeId=$this->PageTypeId");
		
		$delete = mysql_query("DELETE FROM Layouts WHERE PageTypeId=$this->PageTypeId");
		
		$delete = mysql_query("DELETE FROM Categories WHERE PageTypeId=$this->PageTypeId");
