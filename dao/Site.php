...
class Site{
	...
	public static function EditBasic($siteId, $name, $domain, $analyticsId, $facebookAppId, $primaryEmail, $timeZone){
		...
		if(!$result) {
		  print "Could not successfully run query Site->EditBasic" . mysql_error() . "<br>";
		  exit;
		}
	}
	...
	public static function EditLogo($siteId, $logoUrl){
		...
		if(!$result) {
		  print "Could not successfully run query Site->EditLogo" . mysql_error() . "<br>";
		  exit;
		}
	}
	
	// Edits the template
	public static function EditTemplate($siteId, $template){

		Connect::init();
		
		$template = mysql_real_escape_string($template); // clean data
		...
		if(!$result) {
		  print "Could not successfully run query Site->EditTemplate" . mysql_error() . "<br>";
		  exit;
		}
	}
