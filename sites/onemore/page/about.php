...
$dataloc="../";
$commonloc="../../common/";
$domain="sites.respondcms.com/onemore";
$siteId=40;
$siteUniqId="503ed3d173db7";
$pageId=370;
$pageType="content";
$default_url="/page/about.php";
include "../../common/Utilities.php";
include "../../common/API.php";
?><!doctype html>  <!--[if lt IE 7]> <html class="no-js lt-ie9 lt-ie8 lt-ie7" lang="en"> <![endif]-->  <!--[if IE 7]>    <html class="no-js lt-ie9 lt-ie8" lang="en"> <![endif]-->  <!--[if IE 8]>    <html class="no-js lt-ie9" lang="en"> <![endif]-->  <!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->  <head>    <meta charset="utf-8">    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">    <title>onemore - About</title>    <meta name="description" content="">    <meta name="keywords" content="">    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">      <meta name="viewport" content="width=device-width, initial-scale=1.0">      <link href="../css/content.css" type="text/css" rel="stylesheet" media="screen"><link href="../css/bootstrap.min.css" type="text/css" rel="stylesheet" media="screen"><link href="../css/bootstrap-responsive.min.css" type="text/css" rel="stylesheet" media="screen">      </head>    <body id="about" class="page">    <div id="wrapper">    <header class="navbar">
  <div>
<a id="logo" href="../" alt="onemore"><img src="../files/sample-logo.png"></a><h1>onemore</h1>
