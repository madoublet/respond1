...
$pageId=363;
$pageType="content";
$default_url="/page/contact-us.php";
include "../../common/Utilities.php";
include "../../common/API.php";
?><!doctype html> <!--[if lt IE 7]> <html class="no-js lt-ie9 lt-ie8 lt-ie7" lang="en"> <![endif]--> <!--[if IE 7]>    <html class="no-js lt-ie9 lt-ie8" lang="en"> <![endif]--> <!--[if IE 8]>    <html class="no-js lt-ie9" lang="en"> <![endif]--> <!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]--> <head>   <meta charset="utf-8">   <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">   <title>sample - Contact Us</title>   <meta name="description" content="">   <meta name="keywords" content="">   <meta http-equiv="Content-Type" content="text/html; charset=utf-8">    <meta name="viewport" content="width=device-width, initial-scale=1.0">    <link href="../css/content.css" type="text/css" rel="stylesheet" media="screen"><link href="../css/bootstrap.min.css" type="text/css" rel="stylesheet" media="screen"><link href="../css/bootstrap-responsive.min.css" type="text/css" rel="stylesheet" media="screen">    </head>  <body id="contact-us" class="page">  <div id="wrapper">   <header class="navbar">
  <div>
...
</p>          <div id="content" class="container-fluid">     <div id="1343097374" class="block row-fluid"><div class="col span12"><h1 id="h1-1342578154">Contact Us</h1><p id="p-1345932735">Placeholder for the Contact Us page.</p><form class="form-horizontal form-respond">
  <input class="siteUniqId" type="hidden" value="502b03c365cc9">
  <input class="pageUniqId" type="hidden" value="502b03c39aa99">
